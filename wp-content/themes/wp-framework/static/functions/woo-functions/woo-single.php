...
/*
    ...
    -----------------------------------------------------
*/
// add_action('woocommerce_before_main_content', 'jeet_override_woo_breadcrumb', 20);
function jeet_override_woo_breadcrumb($bread) {
    if (is_product()) : ?>
...
add_filter( 'woocommerce_breadcrumb_home_url', 'jeet_woo_custom_breadrumb_home_url' );
function jeet_woo_custom_breadrumb_home_url() {
    if (is_product()) {
...
// add_action('woocommerce_single_product_summary', 'jeet_show_unit_qty_under_title_in_single', 6);
function jeet_show_unit_qty_under_title_in_single() {
    global $product;

    $unit_qty = get_post_meta($product->get_id(), 'jeet_woo_product_unit_qty', true);
...
// add_action('woocommerce_single_product_summary', 'jeet_add_wishlist_after_add_to_cart_shop_sinlge', 41);
function jeet_add_wishlist_after_add_to_cart_shop_sinlge() {
    global $product;
...
// add_action('woocommerce_single_product_summary', 'jeet_move_single_short_desc_after_add_to_cart', 31);
function jeet_move_single_short_desc_after_add_to_cart() {
...
// add_action('woocommerce_single_product_summary', 'jeet_move_product_data_tabs_within_summary_wrapp', 61);
function jeet_move_product_data_tabs_within_summary_wrapp() {
