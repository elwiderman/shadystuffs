...
class SubmissionForm extends \Bricks\Element {
	...
	public function render() {
		...
		$form = FormFactory::make( [
			'id'                  => isset( $settings['meta_box_id'] ) ? $settings['meta_box_id'] : '',
			...
			'post_id'             => isset( $settings['post_id'] ) ? $settings['post_id'] : '',
			...
			'redirect'            => isset( $settings['redirect'] ) ? $settings['redirect'] : '',
			'confirmation'        => $settings['confirmation'],
			'delete_confirmation' => $settings['delete_confirmation'],
			'recaptcha_key'       => isset( $settings['recaptcha_key'] ) ? $settings['recaptcha_key'] : '',
			'recaptcha_secret'    => isset( $settings['recaptcha_secret'] ) ? $settings['recaptcha_secret'] : '',
		] );
