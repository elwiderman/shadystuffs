...
Test Flexible PDF Invoices for WooCommerce & WordPress (free, PRO, and add-ons) in **[your free demo](https://wpde.sk/demo-fi)**.
...
Yes. You can sell based on weight, dimension, area, density, and volume with the [Flexible Quantity – Measurement Price Calculator for WooCommerce plugin](https://wordpress.org/plugins/flexible-quantity-measurement-price-calculator-for-woocommerce/). The Flexible Invoices are compatible with Flexible Quantity, so the new units of measure will appear on your WooCommerce PDF invoices. Read more about [adding new units on your invoices](https://flexibleinvoices.com/blog/create-woocommerce-pdf-invoice-unit-of-measure-free-plugins/).
...
* [**Flexible Checkout Fields**](https://wordpress.org/plugins/flexible-checkout-fields/) - customize the checkout page in WooCommerce with custom fields and this free customizer.
* [**Flexible Product Fields**](https://wordpress.org/plugins/flexible-product-fields/) - build the custom WooCommerce product page with new fields for free!
...
* [**Flexible Wishlist**](https://wordpress.org/plugins/flexible-wishlist/) - let customers add product wishlists in WooCommerce, share their favorite products, or save carts for future shopping!
...
* [**Flexible Refund**](https://wordpress.org/plugins/flexible-refund-and-return-order-for-woocommerce/) - manage customer refunds in WooCommerce with the refund form and faster refund process.
...
1. VAT invoice.
2. Issuing PDF Invoices.
3. All Invoices and Download Invoice buttons.
4. General Settings.
5. Invoice Settings.
6. Settings for WooCommerce Invoices.
7. Settings for WooCommerce checkout and VAT Number.
8. Download Invoices.
9. Generate Reports.
10. Currency Settings.
11. Tax Settings (WordPress only).
12. WordPress and WooCommerce PDF invoicing plugin.
13. Add a new invoice in WordPress or WooCommerce manually.
14. Add invoice items with or without tax.
15. Invoice actions on the WooCommerce Orders screen.
16. The plugin will recognize WooCommerce tax rates for your PDF invoices.
17. Generate a WordPress and WooCommerce invoice (or receipt) for free!
18. Edit, send, and download a PDF invoice in WordPress and WooCommerce.
19. Download the PDF invoice in WooCommerce and WordPress.
20. Download the document (PDF receipt) from the WooCommerce order screen.
21. Send the invoice to your WordPress or WooCommerce customer.
22. Edit the WooCommerce invoice dates.
23. Install the plugin from the WordPress Plugins menu.
24. Invoice with new units of measure in WooCommerce - with a free plugin (get the complete WordPress billing system plugin).
25. Set the seller data for your WooCommerce PDF invoices.
26. Set the seller logo on the Woo Commerce invoice.
27. Print a WooCommerce invoice with the seller's signature.
28. Enable sequential order numbers in WooCommerce.
29. WooCommerce invoicing and sequential order numbers in one plugin!
30. Use the plugin for WooCommerce orders to issue invoices quickly.
31. The WooCommerce payment method on the PDF invoice.
32. WooCommerce PDF invoice (receipt) configuration.
33. Create beautiful pdf invoices (or receipts) in WordPress and WooCommerce.
34. Show the invoice payment link to the WooCommerce checkout (PRO).
35. VAT number in the invoice generator plugin for WooCommerce.
36. Show the VAT number field on the WooCommerce checkout page.
37. Adjust the WooCommerce invoice template with product SKU numbers.
38. Translate your PDF invoices (WPML support and translation ready).
39. WooCommerce Flexible Invoices Poedit translation.
40. Use the invoice template settings to generate custom invoices.
41. Invoice notes with a free plugin for WooCommerce.
42. Enable the EU VAT number validation for WooCommerce invoices (PRO).
43. WooCommerce invoicing plugin with OSS support for EU VAT invoices (PRO).
44. Flexible Invoices WooCommerce (VAT Invoice with OSS example) (PRO).
45. EU VAT WooCommerce OSS validation (PRO).
46. WooCommerce PDF invoice builder (currency exchange table) (PRO).
47. Generate the WooCommerce invoice with an automatic exchange table for VAT (PRO).
48. The free invoicing plugin for WordPress - support tab.
49. Send the WooCommerce invoice with a payment link (PRO).
50. WooCommerce pdf invoices with a custom template (PRO add-on).
51. Personalize WooCommerce invoices with custom styling (PRO add-on).
52. WooCommerce invoice email customization inside the plugin.
53. More invoice templates (invoice, proforma, correction) (PRO).
54. The invoice settings (the invoice template comes in the free plugin).
55. Billing plugin for WordPress and WooCommerce (exclude free items from PDF invoices).
56. The proforma invoice for WooCommerce orders (PRO).
57. The WooCommerce invoice system is compatible with EU law (OSS, reverse charge, EU VAT) (PRO).
58. The OSS invoice after dynamic EU VAT validation in the VIES database (PRO).
59. Issue WooCommerce PDF invoices automatically per chosen order statuses (PRO).
60. Best filters for the invoice plugin to find your WooCommerce invoices (PRO).
61. Send an automatic invoice and correction invoices in WooCommerce (PRO).
...
= 5.6.22 - 2023-12-13 =
* Fixed currency insert button

= 5.6.21 - 2023-11-16 =
* Fixed critical error on template tab
...
= 5.6.16 - 2023-08-22 =
- Removed woocommerce product selector if woocommerce is deactivated,
- Fixed invoice calculation when woocommerce is disabled
...
= 5.6.14 - 2023-06-12 =
* Fixed empty index error when saving customer vat number
* Fixed inserting new tax rates
...
= 5.6.11 - 2023-02-01 =
* Fixed error in PHP 8.0 without woocommerce installed
