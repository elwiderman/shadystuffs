...
class Xoo_Sl_Helper extends Xoo_Helper{
	...
	public function get_x_option( $subkey = '' ){
		return $this->get_option( 'xoo-sl-x-options', $subkey );
	}

	public function get_apple_option( $subkey = '' ){
		return $this->get_option( 'xoo-sl-apl-options', $subkey );
	}
